...
class ContactAdmin(admin.ModelAdmin):
    list_display = ('id', 'first_name', 'last_name', 'email', 'phone', 'show') #mostrar esses campos na listagem
    ...
    list_editable = ('first_name', 'last_name', 'show',) #permitir edição direta dos campos first_name, last_name e show na listagem
